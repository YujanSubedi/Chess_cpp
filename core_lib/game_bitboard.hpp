...
public:
	...
	unsigned long pawn_targets(unsigned long pawn_bitboard, Piece_color selected_color);
	unsigned long pawn_movements(unsigned long pawn_bitboard, Piece_color selected_color);
